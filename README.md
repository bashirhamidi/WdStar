...
##  distances (R² by default; set fit_metric = "aic" or "both"), which can be  
##  used to assess the impact of adjustment on the data.  
...
dist.goodness.of.fit(dm=dm, adjusted_dm=a.dm, metric="both", k=3)
```
